...
parser.add_argument("--logdir", type=str, default="logs/Rain100L_model27",
                    help='path to model and log files')
parser.add_argument("--data_path", type=str, default="datasets/test/test12_real/test12/rainy",
                    help='path to training data')
parser.add_argument("--save_path", type=str, default="./results/test12", help='path to save results')
