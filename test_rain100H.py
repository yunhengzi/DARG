...
parser.add_argument("--logdir", type=str, default="logs/Rain100H", help='path to model and log files')  # 模型保存的位置
parser.add_argument("--data_path", type=str, default="dataset/test/Rain100H/rainy", help='path to training data')
parser.add_argument("--save_path", type=str, default="./results/Rain100H", help='path to save results')  # 结果保存图片
